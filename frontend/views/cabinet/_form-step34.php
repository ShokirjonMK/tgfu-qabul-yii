...
$model->filial_id = $student->filial_id;
$data = [];
...
<div class="step_one_box">
    ...
    <div class="form-group">
        <?= $form->field($model, 'filial_id')->widget(Select2::classname(), [
            'data' => ArrayHelper::map($filials, 'id', 'name_'.$lang),
            'options' => ['placeholder' => Yii::t("app" , "a154")],
            'pluginOptions' => [
                'allowClear' => true
            ],
        ])->label(Yii::t("app" , "a154").' <span>*</span>'); ?>
    </div>
...
$js = <<<JS
    $(document).ready(function() {
        $("#stepthree4-language_id").on('change', function () {
            var form_id = $("#stepthree4-edu_year_form_id").val();
            ...
            if (form_id > 0) {
                $.ajax({
                    ...
                    success: function (data) {
                        $("#stepthree4-direction_id").html(data);
                    },
                    error: function () {
                        alert("Xatolik!!!");
                    }
        ...
        $("#stepthree4-edu_year_form_id").on('change', function () {
            var lang_id = $("#stepthree4-language_id").val();
